...
| <db_ticker>.connection.suffix=<x...x> | <DB_TICKER>_CONNECTION_SUFFIX | INFORMIX | MYSQL | suffix of the database connection string |
...
| <db_ticker>.user.sys=<x...x>> | <DB_TICKER>_USER | INFORMIX | name of the privileged user |
