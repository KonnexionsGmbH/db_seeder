...
| drop.constraints=<yes>                    | DROP_CONSTRAINTS                  | all RDBMS except cockroach, cratedb, h2, mimer, omnisci, sqlite, trino             | drop all contraints before the DML operations and recreate them afterwards |
