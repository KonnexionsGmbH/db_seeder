...
unset DB_SEEDER_ENCODING_ISO_8859_1=
unset DB_SEEDER_ENCODING_UTF_8=
...
unset DB_SEEDER_JDBC_CONNECTION_HOST=

unset DB_SEEDER_MAX_ROW_CITY=
unset DB_SEEDER_MAX_ROW_COMPANY=
unset DB_SEEDER_MAX_ROW_COUNTRY=
unset DB_SEEDER_MAX_ROW_COUNTRY_STATE=
unset DB_SEEDER_MAX_ROW_TIMEZONE=

if [ "$DB_SEEDER_DBMS" = "cratedb" ]; then
    unset DB_SEEDER_CRATEDB_CONNECTION_PORT=
    unset DB_SEEDER_CRATEDB_CONNETION_PREFIX=
    unset DB_SEEDER_CRATEDB_PASSWORD=
    unset DB_SEEDER_CRATEDB_USER=
fi
if [ "$DB_SEEDER_DBMS" = "cubrid" ]; then
    export DB_SEEDER_ENCODING_UTF_8=false
    unset DB_SEEDER_CUBRID_CONNECTION_PORT=
    unset DB_SEEDER_CUBRID_CONNETION_PREFIX=
    unset DB_SEEDER_CUBRID_DATABASE=
    unset DB_SEEDER_CUBRID_PASSWORD=
    unset DB_SEEDER_CUBRID_USER=
fi
if [ "$DB_SEEDER_DBMS" = "derby" ]; then
    unset DB_SEEDER_DERBY_CONNECTION_PORT=
    unset DB_SEEDER_DERBY_CONNETION_PREFIX=
    unset DB_SEEDER_DERBY_DATABASE=
fi
...
if [ "$DB_SEEDER_DBMS" = "firebird" ]; then
    unset DB_SEEDER_FIREBIRD_CONNECTION_PORT=
    unset DB_SEEDER_FIREBIRD_CONNETION_PREFIX=
    unset DB_SEEDER_FIREBIRD_DATABASE=
    unset DB_SEEDER_FIREBIRD_PASSWORD=
    unset DB_SEEDER_FIREBIRD_PASSWORD_SYS=
    unset DB_SEEDER_FIREBIRD_USER=
fi
if [ "$DB_SEEDER_DBMS" = "h2" ]; then
    unset DB_SEEDER_H2_CONNECTION_PORT=
    unset DB_SEEDER_H2_CONNETION_PREFIX=
    unset DB_SEEDER_H2_DATABASE=
    unset DB_SEEDER_H2_PASSWORD=
    unset DB_SEEDER_H2_SCHEMA=
    unset DB_SEEDER_H2_USER=
fi
...
if [ "$DB_SEEDER_DBMS" = "hsqldb_emb" ]; then
    export DB_SEEDER_DBMS_EMBEDDED=yes
    unset DB_SEEDER_HSQLDB_CONNETION_PREFIX=
    unset DB_SEEDER_HSQLDB_DATABASE=
    unset DB_SEEDER_HSQLDB_PASSWORD=
    unset DB_SEEDER_HSQLDB_SCHEMA=
    unset DB_SEEDER_HSQLDB_USER=
fi
if [ "$DB_SEEDER_DBMS" = "ibmdb2" ]; then
    unset DB_SEEDER_IBMDB2_CONNECTION_PORT=
    unset DB_SEEDER_IBMDB2_CONNETION_PREFIX=
    unset DB_SEEDER_IBMDB2_DATABASE=
    unset DB_SEEDER_IBMDB2_PASSWORD=
    unset DB_SEEDER_IBMDB2_SCHEMA=
fi
if [ "$DB_SEEDER_DBMS" = "informix" ]; then
    unset DB_SEEDER_INFORMIX_CONNECTION_PORT=
    unset DB_SEEDER_INFORMIX_CONNETION_PREFIX=
    unset DB_SEEDER_INFORMIX_CONNETION_SUFFIX=
    unset DB_SEEDER_INFORMIX_DATABASE=
    unset DB_SEEDER_INFORMIX_DATABASE_SYS=
    unset DB_SEEDER_INFORMIX_PASSWORD=
    unset DB_SEEDER_INFORMIX_PASSWORD_SYS=
    unset DB_SEEDER_INFORMIX_USER=
    unset DB_SEEDER_INFORMIX_USER_SYS=
fi
if [ "$DB_SEEDER_DBMS" = "mariadb" ]; then
    unset DB_SEEDER_MARIADB_CONNECTION_PORT=
    unset DB_SEEDER_MARIADB_CONNETION_PREFIX=
    unset DB_SEEDER_MARIADB_DATABASE=
    unset DB_SEEDER_MARIADB_PASSWORD=
    unset DB_SEEDER_MARIADB_PASSWORD_SYS=
    unset DB_SEEDER_MARIADB_USER=
fi
if [ "$DB_SEEDER_DBMS" = "mssqlserver" ]; then
    export DB_SEEDER_ENCODING_UTF_8=false
    unset DB_SEEDER_MSSQLSERVER_CONNECTION_PORT=
    unset DB_SEEDER_MSSQLSERVER_CONNETION_PREFIX=
    unset DB_SEEDER_MSSQLSERVER_DATABASE=
    unset DB_SEEDER_MSSQLSERVER_PASSWORD=
    unset DB_SEEDER_MSSQLSERVER_PASSWORD_SYS=
    unset DB_SEEDER_MSSQLSERVER_SCHEMA=
    unset DB_SEEDER_MSSQLSERVER_USER=
fi
if [ "$DB_SEEDER_DBMS" = "mysql" ]; then
    unset DB_SEEDER_MYSQL_CONNECTION_PORT=
    unset DB_SEEDER_MYSQL_CONNETION_PREFIX=
    unset DB_SEEDER_MYSQL_CONNETION_SUFFIX=
    unset DB_SEEDER_MYSQL_DATABASE=
    unset DB_SEEDER_MYSQL_PASSWORD=
    unset DB_SEEDER_MYSQL_PASSWORD_SYS=
    unset DB_SEEDER_MYSQL_USER=
fi
if [ "$DB_SEEDER_DBMS" = "oracle" ]; then
    unset DB_SEEDER_ORACLE_CONNECTION_PORT=
    unset DB_SEEDER_ORACLE_CONNETION_PREFIX=
    unset DB_SEEDER_ORACLE_CONNETION_SERVICE=
    unset DB_SEEDER_ORACLE_PASSWORD=
    unset DB_SEEDER_ORACLE_PASSWORD_SYS=
    unset DB_SEEDER_ORACLE_USER=
fi
if [ "$DB_SEEDER_DBMS" = "postgresql" ]; then
    unset DB_SEEDER_POSTGRESQL_CONNECTION_PORT=
    unset DB_SEEDER_POSTGRESQL_CONNETION_PREFIX=
    unset DB_SEEDER_POSTGRESQL_DATABASE=
    unset DB_SEEDER_POSTGRESQL_PASSWORD=
    unset DB_SEEDER_POSTGRESQL_PASSWORD_SYS=
    unset DB_SEEDER_POSTGRESQL_USER=
fi
if [ "$DB_SEEDER_DBMS" = "sqlite" ]; then
    unset DB_SEEDER_SQLITE_CONNETION_PREFIX=
    unset DB_SEEDER_SQLITE_DATABASE=
fi
