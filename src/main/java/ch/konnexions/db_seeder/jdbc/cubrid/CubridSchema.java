...
public final class CubridSchema implements JdbcSchema {
  ...
  private final static HashMap<String, String> createTableStmnts() {
    ...
    createTableStmnts.put(TABLE_NAME_CITY,
                          """
                          CREATE TABLE "CITY"
                          (
    ...
    createTableStmnts.put(TABLE_NAME_COMPANY,
                          """
    ...
    createTableStmnts.put(TABLE_NAME_COUNTRY,
                          """
    ...
    createTableStmnts.put(TABLE_NAME_COUNTRY_STATE,
                          """
    ...
    createTableStmnts.put(TABLE_NAME_TIMEZONE,
                          """
