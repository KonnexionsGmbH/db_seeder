...
public final class SamplePostgresql {
  ...
  private static final Logger  logger              = Logger.getLogger(SamplePostgresql.class);
  ...
  private static final String  urlPresto           = "jdbc:presto://localhost:8080/db_seeder_postgresql/public?user=presto";
  ...
  private static void demonstratePrestoBatch() {
    if (isDebug) {
      logger.debug("Start");
    }

    logger.info("Run the demo with the Presto JDBC driver - with batch operations");
    logger.info("");
  ...
  public static void main(String[] args) {
    ...
    while (choice < 8) {
      ...
      logger.info("4 - Run the demo with the Presto JDBC driver - with batch operations");
