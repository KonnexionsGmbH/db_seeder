...
public abstract class AbstractGenMonetdbSchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenMonetdbSchema.class);
  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_COUNTRY_STATE,
                   ...
                   CREATE TABLE COUNTRY_STATE (
                       ...
                       NAME                             VARCHAR(100)              NOT NULL,
                       SYMBOL                           VARCHAR(50),
                       CONSTRAINT KXN_43                UNIQUE      (fk_country_id, name)
                   )
                   """);
