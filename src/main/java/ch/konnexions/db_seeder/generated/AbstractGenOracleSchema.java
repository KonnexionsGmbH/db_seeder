  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_COMPANY,
                   ...
                   CREATE TABLE COMPANY (
                       ...
                       FK_CITY_ID                       NUMBER                    NOT NULL REFERENCES CITY                              (PK_CITY_ID),
    ...
    statements.put(TABLE_NAME_COUNTRY_STATE,
                   ...
                   CREATE TABLE COUNTRY_STATE (
                       PK_COUNTRY_STATE_ID              NUMBER                             PRIMARY KEY,
                       FK_COUNTRY_ID                    NUMBER                    NOT NULL REFERENCES COUNTRY                           (PK_COUNTRY_ID),
                       FK_TIMEZONE_ID                   NUMBER                    NOT NULL REFERENCES TIMEZONE                          (PK_TIMEZONE_ID),
