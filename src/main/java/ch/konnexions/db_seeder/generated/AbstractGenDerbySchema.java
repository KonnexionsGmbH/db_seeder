...
public abstract class AbstractGenDerbySchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenDerbySchema.class);
  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_COUNTRY_STATE,
                   ...
                   CREATE TABLE COUNTRY_STATE (
                       ...
                       NAME                             VARCHAR(100)              NOT NULL,
                       SYMBOL                           VARCHAR(50),
                       CONSTRAINT CONSTRAINT_KXN_4    UNIQUE      (fk_country_id, name)
                   )
                   """);
   ...
   */
  public AbstractGenDerbySchema(String tickerSymbolExtern) {
   ...
   */
  public AbstractGenDerbySchema(String tickerSymbolExtern, String dbmsOption) {
