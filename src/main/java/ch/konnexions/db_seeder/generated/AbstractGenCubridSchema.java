  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_CITY,
                   ...
                   CREATE TABLE "CITY" (
                       ...
                       "FK_COUNTRY_STATE_ID"            INT                                FOREIGN KEY REFERENCES "COUNTRY_STATE"                   ("PK_COUNTRY_STATE_ID"),
                       "CITY_MAP"                       BLOB,
    ...
    statements.put(TABLE_NAME_COUNTRY_STATE,
                   ...
                   CREATE TABLE "COUNTRY_STATE" (
                       "PK_COUNTRY_STATE_ID"            INT                                PRIMARY KEY,
                       "FK_COUNTRY_ID"                  INT                       NOT NULL FOREIGN KEY REFERENCES "COUNTRY"                         ("PK_COUNTRY_ID"),
                       "FK_TIMEZONE_ID"                 INT                       NOT NULL FOREIGN KEY REFERENCES "TIMEZONE"                        ("PK_TIMEZONE_ID"),
