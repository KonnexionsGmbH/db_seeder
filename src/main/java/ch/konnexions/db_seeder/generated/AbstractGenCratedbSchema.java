...
public abstract class AbstractGenCratedbSchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenCratedbSchema.class);
   ...
   */
  public AbstractGenCratedbSchema(String tickerSymbol, String dbmsOption) {
