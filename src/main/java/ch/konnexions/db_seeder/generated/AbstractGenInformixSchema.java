  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_TEST_TABLE_1,
                   ...
                   CREATE TABLE TEST_TABLE_1 (
                       ...
                       COLUMN_1_02                      BIGINT,
                       COLUMN_1_03                      BLOB,
                       COLUMN_1_04                      DATETIME YEAR TO FRACTION NOT NULL,
                       COLUMN_1_05                      DATETIME YEAR TO FRACTION,
    ...
    statements.put(TABLE_NAME_TEST_TABLE_2,
                   ...
                   CREATE TABLE TEST_TABLE_2 (
                       ...
                       COLUMN_2_07                      DATETIME YEAR TO FRACTION NOT NULL,
                       COLUMN_2_08                      CLOB,
                       COLUMN_2_09                      VARCHAR(100),
                       COLUMN_2_10                      VARCHAR(50),
                       COLUMN_2_11                      DATETIME YEAR TO FRACTION,
                       ...
                       UNIQUE      (COLUMN_2_13, COLUMN_2_14),
                       PRIMARY KEY (COLUMN_2_01, COLUMN_2_02, COLUMN_2_03)
                   )
                   """);
    ...
    statements.put(TABLE_NAME_TEST_TABLE_3,
                   ...
                   CREATE TABLE TEST_TABLE_3 (
                       COLUMN_3_01                      BIGINT                    NOT NULL
                                                                                  PRIMARY KEY,
                       COLUMN_3_02                      BLOB,
                       COLUMN_3_03                      DATETIME YEAR TO FRACTION NOT NULL,
                       COLUMN_3_04                      VARCHAR(50),
                       COLUMN_3_05                      DATETIME YEAR TO FRACTION,
    ...
    statements.put(TABLE_NAME_TEST_TABLE_4,
                   ...
                   CREATE TABLE TEST_TABLE_4 (
                       ...
                       COLUMN_4_04                      BLOB,
                       COLUMN_4_05                      DATETIME YEAR TO FRACTION NOT NULL,
                       COLUMN_4_06                      DATETIME YEAR TO FRACTION,
                       COLUMN_4_07                      VARCHAR(100)              NOT NULL
                                                                                  UNIQUE,
                       COLUMN_4_08                      VARCHAR(50),
                       UNIQUE      (COLUMN_4_02, COLUMN_4_07)
                   )
                   """);
    ...
    statements.put(TABLE_NAME_TEST_TABLE_5,
                   ...
                   CREATE TABLE TEST_TABLE_5 (
                       ...
                       COLUMN_5_02                      VARCHAR(50)               NOT NULL
                                                                                  UNIQUE,
                       COLUMN_5_03                      DATETIME YEAR TO FRACTION NOT NULL,
                       COLUMN_5_04                      DATETIME YEAR TO FRACTION,
                       COLUMN_5_05                      VARCHAR(100)              NOT NULL
                                                                                  UNIQUE,
                       COLUMN_5_06                      LVARCHAR(4000)
                   )
                   """);
