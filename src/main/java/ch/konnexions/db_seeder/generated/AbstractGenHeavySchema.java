...
/**
 * CREATE TABLE statements for a HeavyDB DBMS. <br>
 * 
 * @author  CreateSummaryFile.class
 * @version 3.0.7
 */
public abstract class AbstractGenHeavySchema extends AbstractGenSeeder {

  public static final HashMap<String, String> createTableStmnts = createTableStmnts();

  private static final Logger                 logger            = LogManager.getLogger(AbstractGenHeavySchema.class);
  ...
  /**
   * Initialises a new abstract HeavyDB schema object.
   *
   * @param tickerSymbolExtern the external DBMS ticker symbol
   * @param dbmsOption client, embedded or trino
   */
  public AbstractGenHeavySchema(String tickerSymbolExtern, String dbmsOption) {
