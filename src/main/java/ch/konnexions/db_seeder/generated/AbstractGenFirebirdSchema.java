...
public abstract class AbstractGenFirebirdSchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = Logger.getLogger(AbstractGenFirebirdSchema.class);
  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_TEST_TABLE_2,
                   ...
                   CREATE TABLE TEST_TABLE_2 (
                       ...
                       CONSTRAINT CONSTRAINT_7        UNIQUE      (COLUMN_2_13, COLUMN_2_14),
                       CONSTRAINT CONSTRAINT_8        PRIMARY KEY (COLUMN_2_01, COLUMN_2_02, COLUMN_2_03)
                   )
                   """);
    ...
    statements.put(TABLE_NAME_TEST_TABLE_4,
                   ...
                   CREATE TABLE TEST_TABLE_4 (
                       ...
                       CONSTRAINT CONSTRAINT_9        UNIQUE      (COLUMN_4_02, COLUMN_4_07)
                   )
                   """);
