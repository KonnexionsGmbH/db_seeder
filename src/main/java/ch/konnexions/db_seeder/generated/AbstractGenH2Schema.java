...
public abstract class AbstractGenH2Schema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenH2Schema.class);
  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_COUNTRY_STATE,
                   ...
                   CREATE TABLE COUNTRY_STATE (
                       ...
                       NAME                             VARCHAR(100)              NOT NULL,
                       SYMBOL                           VARCHAR(50),
                       CONSTRAINT CONSTRAINT_KXN_6    UNIQUE      (fk_country_id, name)
                   )
                   """);
   ...
   */
  public AbstractGenH2Schema(String tickerSymbol, String dbmsOption) {
