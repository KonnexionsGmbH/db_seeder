...
public abstract class AbstractGenExasolSchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenExasolSchema.class);
   ...
   */
  public AbstractGenExasolSchema(String tickerSymbol, String dbmsOption) {
