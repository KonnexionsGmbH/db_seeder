...
public abstract class AbstractGenVoltdbSchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenVoltdbSchema.class);
   ...
   */
  public AbstractGenVoltdbSchema(String tickerSymbol, String dbmsOption) {
