...
public abstract class AbstractGenHsqldbSchema extends AbstractGenSeeder {
  ...
  private static final Logger                 logger            = LogManager.getLogger(AbstractGenHsqldbSchema.class);
  ...
  private static HashMap<String, String> createTableStmnts() {
    ...
    statements.put(TABLE_NAME_COUNTRY_STATE,
                   ...
                   CREATE TABLE COUNTRY_STATE (
                       ...
                       NAME                             VARCHAR(100)              NOT NULL,
                       SYMBOL                           VARCHAR(50),
                       CONSTRAINT CONSTRAINT_KXN_7    UNIQUE      (fk_country_id, name)
                   )
                   """);
   ...
   */
  public AbstractGenHsqldbSchema(String tickerSymbol, String dbmsOption) {
