...
@REM     call run_db_seeder agens            yes 2
@REM     call run_db_seeder cockroach        yes 2
@REM     call run_db_seeder cratedb          yes 2
@REM     call run_db_seeder cubrid           yes 2
@REM     call run_db_seeder derby            yes 2
@REM     call run_db_seeder derby_emb        yes 2
@REM     call run_db_seeder exasol           yes 2
@REM     call run_db_seeder firebird         yes 2
@REM     call run_db_seeder h2               yes 2
@REM     call run_db_seeder h2_emb           yes 2
@REM     call run_db_seeder hsqldb           yes 2
@REM     call run_db_seeder hsqldb_emb       yes 2
@REM     call run_db_seeder ibmdb2           yes 2
@REM     call run_db_seeder informix         yes 2
@REM     call run_db_seeder mariadb          yes 2
@REM     call run_db_seeder mimer            yes 2
@REM     call run_db_seeder monetdb          yes 2
@REM     call run_db_seeder mysql            yes 2
@REM     call run_db_seeder mysql_trino      yes 2
    call run_db_seeder omnisci          yes 1
    call run_db_seeder oracle           yes 2
    call run_db_seeder oracle_trino     yes 2
    call run_db_seeder percona          yes 2
    call run_db_seeder postgresql       yes 2
    call run_db_seeder postgresql_trino yes 2
    call run_db_seeder sqlite           yes 2
    call run_db_seeder sqlserver        yes 2
    call run_db_seeder sqlserver_trino  yes 2
...
@REM     call run_db_seeder oracle           yes 2
@REM     call run_db_seeder oracle_trino     no  1
@REM     call run_db_seeder percona          yes 2
@REM     call run_db_seeder postgresql       yes 2
@REM     call run_db_seeder postgresql_trino no  1
@REM     call run_db_seeder sqlite           no  1
@REM     call run_db_seeder sqlserver        yes 2
