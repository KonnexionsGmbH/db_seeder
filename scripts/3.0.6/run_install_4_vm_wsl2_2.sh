...
echo "Start $0"
echo "------------------------------------------------------------------------------"
echo "Install a db_seeder_dev environment for Ubuntu 20.04 - Step 2."
echo "------------------------------------------------------------------------------"
...
echo " "
echo "=============================================================================="
sudo rm -rf ${HOME}/.asdf/downloads/gradle
sudo rm -rf ${HOME}/.asdf/downloads/java
sudo rm -rf ${HOME}/.asdf/downloads/python

sudo rm -rf ${HOME}/.asdf/installs/gradle
sudo rm -rf ${HOME}/.asdf/installs/java
sudo rm -rf ${HOME}/.asdf/installs/python

sudo rm -rf ${HOME}/.asdf/plugins/gradle
sudo rm -rf ${HOME}/.asdf/plugins/java
