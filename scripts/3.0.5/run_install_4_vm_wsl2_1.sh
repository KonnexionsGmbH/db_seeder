...
mkdir -p ~/db_seeder_install

cp -r ../../../scripts/run_version_check.sh ~/db_seeder_install
cp -r config_dbeaver ~/db_seeder_install
...
echo '' >> ~/.bashrc
echo '# ----------------------------------------------------------------------------' >> ~/.bashrc
echo '# Environment db_seeder_dev for Ubuntu 20.04 - End' >> ~/.bashrc
echo '# ----------------------------------------------------------------------------' >> ~/.bashrc
