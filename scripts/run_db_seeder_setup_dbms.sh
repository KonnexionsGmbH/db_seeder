...
if [ "$DB_SEEDER_DBMS" = "informix" ]; then
    ...
    docker create --name db_seeder_db -e LICENSE=accept -e DB_INIT=1 -m 4GB -p 9088:9088 --privileged ibmcom/informix-developer-database:$DB_SEEDER_INFORMIX_VERSION
