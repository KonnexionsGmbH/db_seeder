...
export DB_SEEDER_FILE_STATISTICS_NAME=db_seeder_cmd_complete_company_9.9.9_win10.tsv

rm -rf resources/staistics/db_seeder_cmd_complete_company_9.9.9_win10.tsv
